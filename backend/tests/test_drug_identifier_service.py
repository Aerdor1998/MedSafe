...
class TestDrugIdentification:
    ...
    def test_drug_identification_creation(self):
        ...
        from backend.app.services.drug_identifier import DrugIdentification, IdentificationMethod
...
class TestGetDrugIdentifier:
    ...
    def test_get_drug_identifier_returns_instance(self):
        ...
        from backend.app.services.drug_identifier import get_drug_identifier, HybridDrugIdentifier
...
class TestResetIdentifier:
    ...
    def test_reset_identifier(self):
        ...
        from backend.app.services.drug_identifier import reset_identifier, get_drug_identifier
