...
class TestAuditEvent:
    ...
    def test_audit_event_creation(self):
        ...
        from backend.app.utils.audit_logger import AuditEvent, AuditEventType, AuditSeverity
        from datetime import datetime
...
class TestAuditLogger:
    ...
    def test_audit_logger_log_event(self):
        ...
        from backend.app.utils.audit_logger import AuditLogger, AuditEvent, AuditEventType, AuditSeverity
        from datetime import datetime
