...
class TestAnalysisWorkflow:
    ...
    def test_full_analysis_workflow_frontend(
        self, page: Page, api_url: str, test_patient_data: dict, test_medication: dict
    ):
    ...
    def test_api_v2_analyze_workflow(
        self, page: Page, api_url: str, test_patient_data: dict
    ):
